...
void Beleg::Main::init(){
  ...
  dice4 = new Button(glm::vec3(160, 40, 0), &quadMesh, &diceTexture1, &diceTexture1, glm::vec2(25, 25));
  dice5 = new Button(glm::vec3(200, 40, 0), &quadMesh, &diceTexture1, &diceTexture1, glm::vec2(25, 25));
